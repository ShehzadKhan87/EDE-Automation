...
public class TestCase2_F extends BaseTest {

	@Test
	public void testCase2_F() throws Exception {

		ExtentTestManager.createTest("Test case 2.F", "Test case 2.F");
		...
		String state = Utility.getDate_TestCase2F("state");
		String firstName = Utility.getDate_TestCase2F("firstName");
		String lastName = Utility.getDate_TestCase2F("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase2F("age");
		String streetAddress = Utility.getDate_TestCase2F("streetAddress");
		String city = Utility.getDate_TestCase2F("city");
		String zipCode = Utility.getDate_TestCase2F("zipCode");
		String county = Utility.getDate_TestCase2F("county");
		String phoneNumber = Utility.getDate_TestCase2F("phoneNumber");
		String phoneType = Utility.getDate_TestCase2F("phoneType");
		String SSN = Utility.getDate_TestCase2F("SSN");
		String spouseSSN = Utility.getDate_TestCase2F("spouseSSN");
		String relationShip = Utility.getDate_TestCase2F("relationShip");
		String spouseFirstName = Utility.getDate_TestCase2F("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase2F("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase2F("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase2F("babyCount");
		String incomeAmount = Utility.getDate_TestCase2F("incomeAmount");
		String incomeType = Utility.getDate_TestCase2F("incomeType");
		String employerName = Utility.getDate_TestCase2F("employerName");
		String incomePeriod = Utility.getDate_TestCase2F("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase2F("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase2F("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase2F("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase2F("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase2F("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase2F("gotMarried");
		String childFirstName = Utility.getDate_TestCase2F("childFirstName");
		String childLastName = Utility.getDate_TestCase2F("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase2F("childAge");
		String childRelationShip = Utility.getDate_TestCase2F("childRelationShip");
		String plan = Utility.getDate_TestCase2F("plan");
		String withoutDocument = Utility.getDate_TestCase2F("withoutDocument");
		String expenseAmount = Utility.getDate_TestCase2F("expenseAmount");
		String anualPredictedAmount = Utility.getDate_TestCase2F("anualPredictedAmount");
		...
		commonMethodPage.immigrationStatus_S019(withoutDocument);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.whoIsIncarcerated_S094(spouseFullName);
		commonMethodPage.whoIsIncarcerated_S094(childFullName);
		commonMethodPage.incarceratedPendingDisposition_S094_P1(no);
		commonMethodPage.incarceratedPendingDisposition_S094_P2(yes);
		commonMethodPage.clickSaveAndContinueButton();
