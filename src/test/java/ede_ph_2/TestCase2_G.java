...
public class TestCase2_G extends BaseTest {
	@Test
	public void testCase2_G() throws Exception {

		ExtentTestManager.createTest("Test case 2.G", "Test case 2.G");
		...
		String state = Utility.getDate_TestCase2G("state");
		String firstName = Utility.getDate_TestCase2G("firstName");
		String lastName = Utility.getDate_TestCase2G("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase2G("age");
		String streetAddress = Utility.getDate_TestCase2G("streetAddress");
		String city = Utility.getDate_TestCase2G("city");
		String zipCode = Utility.getDate_TestCase2G("zipCode");
		String county = Utility.getDate_TestCase2G("county");
		String phoneNumber = Utility.getDate_TestCase2G("phoneNumber");
		String phoneType = Utility.getDate_TestCase2G("phoneType");
		String SSN = Utility.getDate_TestCase2G("SSN");
		String daughterSSN = Utility.getDate_TestCase2G("daughterSSN");
		String sonSSN = Utility.getDate_TestCase2G("sonSSN");
		String relationShip = Utility.getDate_TestCase2G("relationShip");
		String daughterFirstName = Utility.getDate_TestCase2G("daughterFirstName");
		String daughterLastName = Utility.getDate_TestCase2G("daughterLastName");
		String daughterFullName = daughterFirstName + " " + daughterLastName;
		String s050OptionPregnant = Utility.getDate_TestCase2G("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase2G("babyCount");
		String incomeAmount = Utility.getDate_TestCase2G("incomeAmount");
		String incomeType = Utility.getDate_TestCase2G("incomeType");
		String employerName = Utility.getDate_TestCase2G("employerName");
		String incomePeriod = Utility.getDate_TestCase2G("incomePeriod");
		String EmployerPhone = Utility.getDate_TestCase2G("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase2G("gotMarried");
		String sonFirstName = Utility.getDate_TestCase2G("sonFirstName");
		String sonLastName = Utility.getDate_TestCase2G("sonLastName");
		String sonFullName = sonFirstName + " " + sonLastName;
		String sonFirstNameSSN = Utility.getDate_TestCase2G("sonFirstNameSSN");
		String sonAge = Utility.getDate_TestCase2G("sonAge");
		String daughterAge = Utility.getDate_TestCase2G("daughterAge");
		String sonRelationShip = Utility.getDate_TestCase2G("sonRelationShip");
		String plan = Utility.getDate_TestCase2G("plan");
		String withoutDocument = Utility.getDate_TestCase2G("withoutDocument");
		String expenseAmount = Utility.getDate_TestCase2G("expenseAmount");
		String anualPredictedAmount = Utility.getDate_TestCase2G("anualPredictedAmount");
		String recentlyMoved = Utility.getDate_TestCase2G("recentlyMoved");
		String movedZipCode = Utility.getDate_TestCase2G("movedZipCode");
		...
		String s012SameNameQuestionDaughter = "Is " + daughterFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestionFemale");
		String s012SameNameQuestionSon = "Is " + sonFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestion");
		...
		String s038QuestionSon = "Does " + sonFullName + " " + Utility.getFromTextProperties("s038Question");
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation(relationShip, sonRelationShip, "not applicable", "2");
		...
		commonMethodPage.selectDependent(sonFirstName);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.applicantTakeCareOfChildrenFirst_S038(sonFirstName);
		commonMethodPage.clickSaveAndContinueButton();
		Wait.wait5Second();
		...
		commonMethodPage.enterSSN(daughterSSN, s012SameNameQuestionDaughter);
		commonMethodPage.selectWithSameName(yes);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.enterSSN(sonSSN, s012SameNameQuestionSon);
		commonMethodPage.selectWithSameName(no);
		commonMethodPage.enterFirstName(sonFirstNameSSN);
		commonMethodPage.enterLastName(sonLastName);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.whoIsInFosterCare_S054(daughterFullName);
		commonMethodPage.selectFosterCareState(state);
		commonMethodPage.receivingMedicaidWhileFosterCare_S054(yes);

		if (state.equals("AR") || state.equals("DE") || state.equals("MO") || state.equals("MS") || state.equals("NC")
				|| state.equals("ND") || state.equals("FL") || state.equals("OK")) {
			leftFosterCareAge = "21";
		} else if (state.equals("MI") || state.equals("MT") || state.equals("NE")
				|| state.equals("SC")) {
