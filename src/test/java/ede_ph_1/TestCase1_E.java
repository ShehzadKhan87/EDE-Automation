...
public class TestCase1_E extends BaseTest {
	@Test
	public void testCase1_E() throws Exception {

		ExtentTestManager.createTest("Test case 1.E", "Test case 1.E");
		...
		// Get data from testcase1E.properties
		String state = Utility.getDate_TestCase1_E("state");
		String firstName = Utility.getDate_TestCase1_E("firstName");
		String lastName = Utility.getDate_TestCase1_E("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase1_E("age");
		String streetAddress = Utility.getDate_TestCase1_E("streetAddress");
		String city = Utility.getDate_TestCase1_E("city");
		String zipCode = Utility.getDate_TestCase1_E("zipCode");
		String county = Utility.getDate_TestCase1_E("county");
		String phoneNumber = Utility.getDate_TestCase1_E("phoneNumber");
		String phoneType = Utility.getDate_TestCase1_E("phoneType");
		String SSN = Utility.getDate_TestCase1_E("SSN");
		String spouseSSN = Utility.getDate_TestCase1_E("spouseSSN");
		String relationShip = Utility.getDate_TestCase1_E("relationShip");
		String spouseFirstName = Utility.getDate_TestCase1_E("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase1_E("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase1_E("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase1_E("babyCount");
		String incomeAmount = Utility.getDate_TestCase1_E("incomeAmount");
		String incomeType = Utility.getDate_TestCase1_E("incomeType");
		String employerName = Utility.getDate_TestCase1_E("employerName");
		String incomePeriod = Utility.getDate_TestCase1_E("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase1_E("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase1_E("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase1_E("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase1_E("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase1_E("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase1_E("gotMarried");
		String spouseAge = Utility.getDate_TestCase1_E("spouseAge");
