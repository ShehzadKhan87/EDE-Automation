...
public class TestCase1_M extends BaseTest {
	@Test
	public void testCase1_M() throws Exception {

		ExtentTestManager.createTest("Test case 1.M", "Test case 1.M");
		...
		String state = Utility.getDate_TestCase1_M("state");
		String firstName = Utility.getDate_TestCase1_M("firstName");
		String lastName = Utility.getDate_TestCase1_M("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase1_M("age");
		String streetAddress = Utility.getDate_TestCase1_M("streetAddress");
		String city = Utility.getDate_TestCase1_M("city");
		String zipCode = Utility.getDate_TestCase1_M("zipCode");
		String county = Utility.getDate_TestCase1_M("county");
		String phoneNumber = Utility.getDate_TestCase1_M("phoneNumber");
		String phoneType = Utility.getDate_TestCase1_M("phoneType");
		String SSN = Utility.getDate_TestCase1_M("SSN");
		String spouseSSN = Utility.getDate_TestCase1_M("spouseSSN");
		String relationShip = Utility.getDate_TestCase1_M("relationShip");
		String spouseFirstName = Utility.getDate_TestCase1_M("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase1_M("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase1_M("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase1_M("babyCount");
		String incomeAmount = Utility.getDate_TestCase1_M("incomeAmount");
		String incomeType = Utility.getDate_TestCase1_M("incomeType");
		String employerName = Utility.getDate_TestCase1_M("employerName");
		String incomePeriod = Utility.getDate_TestCase1_M("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase1_M("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase1_M("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase1_M("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase1_M("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase1_M("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase1_M("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase1_M("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase1_M("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase1_M("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase1_M("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase1_M("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase1_M("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase1_M("childRelationShip");
		String plan = Utility.getDate_TestCase1_M("plan");
		String brotherRelation = Utility.getDate_TestCase1_M("brotherRelation");
		String firstChildSSN = Utility.getDate_TestCase1_M("firstChildSSN");
		String secondChildSSN = Utility.getDate_TestCase1_M("secondChildSSN");
		String expenseAmount = Utility.getDate_TestCase1_M("expenseAmount");
		String coverageName = Utility.getDate_TestCase1_M("coverageName");
		String policyNumber = Utility.getDate_TestCase1_M("policyNumber");
...
//								ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.enterCoverageName(coverageName);
		commonMethodPage.enterPolicyNumber(policyNumber);
		commonMethodPage.clickSaveAndContinueButton();
