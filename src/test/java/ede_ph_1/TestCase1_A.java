...
public class TestCase1_A extends BaseTest {
	@Test
	public void testCase1_A() throws Exception {

		ExtentTestManager.createTest("Test case 1.A", "Test case 1.A");
		...
		// Get data from testcase1A.properties
		String state = Utility.getData_TestCase1_A("state");
		String firstName = Utility.getData_TestCase1_A("firstName");
		String lastName = Utility.getData_TestCase1_A("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getData_TestCase1_A("age");
		String streetAddress = Utility.getData_TestCase1_A("streetAddress");
		String city = Utility.getData_TestCase1_A("city");
		String zipCode = Utility.getData_TestCase1_A("zipCode");
		String county = Utility.getData_TestCase1_A("county");
		String phoneNumber = Utility.getData_TestCase1_A("phoneNumber");
		String phoneType = Utility.getData_TestCase1_A("phoneType");
		String SSN = Utility.getData_TestCase1_A("SSN");
		String spouseSSN = Utility.getData_TestCase1_A("spouseSSN");
		String relationShip = Utility.getData_TestCase1_A("relationShip");
		String spouseFirstName = Utility.getData_TestCase1_A("spouseFirstName");
		String spouseLastName = Utility.getData_TestCase1_A("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getData_TestCase1_A("s050OptionPregnant");
		String babyCount = Utility.getData_TestCase1_A("babyCount");
		String incomeAmount = Utility.getData_TestCase1_A("incomeAmount");
		String incomeType = Utility.getData_TestCase1_A("incomeType");
		String employerName = Utility.getData_TestCase1_A("employerName");
		String incomePeriod = Utility.getData_TestCase1_A("incomePeriod");
		String spouseIncomeAmount = Utility.getData_TestCase1_A("spouseIncomeAmount");
		String spouseIncomeType = Utility.getData_TestCase1_A("spouseIncomeType");
		String spouseEmployerName = Utility.getData_TestCase1_A("spouseEmployerName");
		String spouseIncomePeriod = Utility.getData_TestCase1_A("spouseIncomePeriod");
		String EmployerPhone = Utility.getData_TestCase1_A("EmployerPhone");
		String gotMarried = Utility.getData_TestCase1_A("gotMarried");
		String spouseAge = Utility.getData_TestCase1_A("spouseAge");
		...
		System.out.println(ESTTimeZone.getCurrentYear());
