...
public class TestCase1_L extends BaseTest {

	@Test
	public void testCase1_L() throws Exception {
		ExtentTestManager.createTest("Test case 1.L", "Test case 1.L");
		...
		String state = Utility.getDate_TestCase1L("state");
		String firstName = Utility.getDate_TestCase1L("firstName");
		String lastName = Utility.getDate_TestCase1L("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase1L("age");
		String streetAddress = Utility.getDate_TestCase1L("streetAddress");
		String city = Utility.getDate_TestCase1L("city");
		String zipCode = Utility.getDate_TestCase1L("zipCode");
		String county = Utility.getDate_TestCase1L("county");
		String phoneNumber = Utility.getDate_TestCase1L("phoneNumber");
		String phoneType = Utility.getDate_TestCase1L("phoneType");
		String SSN = Utility.getDate_TestCase1L("SSN");
		String spouseSSN = Utility.getDate_TestCase1L("spouseSSN");
		String relationShip = Utility.getDate_TestCase1L("relationShip");
		String spouseFirstName = Utility.getDate_TestCase1L("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase1L("spouseLastName");
		...
		String babyCount = Utility.getDate_TestCase1L("babyCount");
		String incomeAmount = Utility.getDate_TestCase1L("incomeAmount");
		String incomeType = Utility.getDate_TestCase1L("incomeType");
		String employerName = Utility.getDate_TestCase1L("employerName");
		String incomePeriod = Utility.getDate_TestCase1L("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase1L("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase1L("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase1L("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase1L("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase1L("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase1L("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase1L("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase1L("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase1L("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase1L("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase1L("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase1L("secondChildAge");
		String thirdChildFirstName = Utility.getDate_TestCase1L("thirdChildFirstName");
		String thirdChildLastName = Utility.getDate_TestCase1L("thirdChildLastName");
		String thirdChildFullName = thirdChildFirstName + " " + thirdChildLastName;
		String thirdChildAge = Utility.getDate_TestCase1L("thirdChildAge");
		String childRelationShip = Utility.getDate_TestCase1L("childRelationShip");
		String plan = Utility.getDate_TestCase1L("plan");
		String brotherRelation = Utility.getDate_TestCase1L("brotherRelation");
		String firstChildSSN = Utility.getDate_TestCase1L("firstChildSSN");
		String secondChildSSN = Utility.getDate_TestCase1L("secondChildSSN");
		String thirdChildSSN = Utility.getDate_TestCase1L("thirdChildSSN");
		...
		// SSN for male
		ExtentTestManager.getTest().info("---------------------SCREEN S012----------------------------");
		// commonMethodPage.verifyS012Optional(s012QuestionSpouseOptional);
		Wait.wait5Second();
		commonMethodPage.enterSSN(spouseSSN, s012SameNameQuestion);
		commonMethodPage.selectWithSameName(yes);
		commonMethodPage.clickSaveAndContinueButton();
