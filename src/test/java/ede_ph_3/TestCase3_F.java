...
public class TestCase3_F extends BaseTest {

	@Test
	public void testCase3_F() throws Exception {

		ExtentTestManager.createTest("Test case 3.F", "Test case 3.F");
		...
		String state = Utility.getDate_TestCase3_F("state");
		String firstName = Utility.getDate_TestCase3_F("firstName");
		String lastName = Utility.getDate_TestCase3_F("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase3_F("age");
		String streetAddress = Utility.getDate_TestCase3_F("streetAddress");
		String city = Utility.getDate_TestCase3_F("city");
		String zipCode = Utility.getDate_TestCase3_F("zipCode");
		String county = Utility.getDate_TestCase3_F("county");
		String phoneNumber = Utility.getDate_TestCase3_F("phoneNumber");
		String phoneType = Utility.getDate_TestCase3_F("phoneType");
		String SSN = Utility.getDate_TestCase3_F("SSN");
		String spouseSSN = Utility.getDate_TestCase3_F("spouseSSN");
		String relationShip = Utility.getDate_TestCase3_F("relationShip");
		String spouseFirstName = Utility.getDate_TestCase3_F("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase3_F("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase3_F("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase3_F("babyCount");
		String incomeAmount = Utility.getDate_TestCase3_F("incomeAmount");
		String incomeType = Utility.getDate_TestCase3_F("incomeType");
		String employerName = Utility.getDate_TestCase3_F("employerName");
		String incomePeriod = Utility.getDate_TestCase3_F("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase3_F("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase3_F("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase3_F("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase3_F("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase3_F("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase3_F("gotMarried");
		String childFirstName = Utility.getDate_TestCase3_F("childFirstName");
		String childLastName = Utility.getDate_TestCase3_F("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase3_F("childAge");
		String childRelationShip = Utility.getDate_TestCase3_F("childRelationShip");
		String plan = Utility.getDate_TestCase3_F("plan");
		String withoutDocument = Utility.getDate_TestCase3_F("withoutDocument");
		String expenseAmount = Utility.getDate_TestCase3_F("expenseAmount");
		String anualPredictedAmount = Utility.getDate_TestCase3_F("anualPredictedAmount");
		String otherAddress = Utility.getDate_TestCase3_F("otherAddress");
		String otherStreetAddress = Utility.getDate_TestCase3_F("otherStreetAddress");
		String otherCity = Utility.getDate_TestCase3_F("otherCity");
		String otherZipCode = Utility.getDate_TestCase3_F("otherZipCode");
		String otherCounty = Utility.getDate_TestCase3_F("otherCounty");
		String otherState = Utility.getDate_TestCase3_F("otherState");
		String FoundNotEligibleDate = ESTTimeZone.getPreviousDate("38", "MM/dd/yyyy");
		String hours = Utility.getDate_TestCase3_F("hours");
		...
		commonMethodPage.doesApplicantFileAsHouseHold_027(no);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.foundNotEligibleMedicaidOrCHIP_S046(childFullName);
		commonMethodPage.s046EnterDate(FoundNotEligibleDate);
		commonMethodPage.clickSaveAndContinueButton();

		ExtentTestManager.getTest().info("---------------------SCREEN S047----------------------------");
		commonMethodPage.applyForHealthCoverage_S047(childFullName);
		commonMethodPage.clickSaveAndContinueButton();
