...
public class TestCase3_H extends BaseTest {
	@Test
	public void testCase3_H() throws Exception {

		ExtentTestManager.createTest("Test case 3.H", "Test case 3.H");
		...
		String socialSecurityBenefit = Utility.getValue("socialSecurityBenefit");
		String medicare = Utility.getValue("medicare");

		// Get data from testcase3H.properties
		String state = Utility.getDate_TestCase3_H("state");
		String firstName = Utility.getDate_TestCase3_H("firstName");
		String lastName = Utility.getDate_TestCase3_H("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase3_H("age");
		String streetAddress = Utility.getDate_TestCase3_H("streetAddress");
		String city = Utility.getDate_TestCase3_H("city");
		String zipCode = Utility.getDate_TestCase3_H("zipCode");
		String county = Utility.getDate_TestCase3_H("county");
		String phoneNumber = Utility.getDate_TestCase3_H("phoneNumber");
		String phoneType = Utility.getDate_TestCase3_H("phoneType");
		String relationShip = Utility.getDate_TestCase3_H("relationShip");
		String spouseFirstName = Utility.getDate_TestCase3_H("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase3_H("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String incomeAmount = Utility.getDate_TestCase3_H("incomeAmount");
		String incomeType = Utility.getDate_TestCase3_H("incomeType");
		String employerName = Utility.getDate_TestCase3_H("employerName");
		String incomePeriod = Utility.getDate_TestCase3_H("incomePeriod");
		String mamaIncomeAmount = Utility.getDate_TestCase3_H("mamaIncomeAmount");
		String mamaEmployerName = Utility.getDate_TestCase3_H("mamaEmployerName");
		String mamaIncomePeriod = Utility.getDate_TestCase3_H("mamaIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase3_H("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase3_H("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase3_H("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase3_H("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase3_H("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase3_H("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase3_H("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase3_H("secondChildAge");
		String motherFirstName = Utility.getDate_TestCase3_H("motherFirstName");
		String motherLastName = Utility.getDate_TestCase3_H("motherLastName");
		String motherFullName = motherFirstName + " " + motherLastName;
		String motherAge = Utility.getDate_TestCase3_H("motherAge");
		String childRelationShip = Utility.getDate_TestCase3_H("childRelationShip");
		String brotherRelation = Utility.getDate_TestCase3_H("brotherRelation");
		String parentRelation = Utility.getDate_TestCase3_H("parentRelation");
		...
		String fatherAge = Utility.getDate_TestCase3_H("fatherAge");
		String grandDaughterFirstName = Utility.getDate_TestCase3_H("grandDaughterFirstName");
		String grandDaughterLastName = Utility.getDate_TestCase3_H("grandDaughterLastName");
		String grandDaughterFullName = grandDaughterFirstName + " " + grandDaughterLastName;
		String grandDaughterAge = Utility.getDate_TestCase3_H("grandDaughterAge");
		String husbandStreetAddress = Utility.getDate_TestCase3_H("husbandStreetAddress");
		String otherAddress = Utility.getDate_TestCase3_H("otherAddress");
		String otherStreetAddress = Utility.getDate_TestCase3_H("otherStreetAddress");
		String otherCity = Utility.getDate_TestCase3_H("otherCity");
		String otherZipCode = Utility.getDate_TestCase3_H("otherZipCode");
		String otherCounty = Utility.getDate_TestCase3_H("otherCounty");
		String otherState = Utility.getDate_TestCase3_H("otherState");
		...
		String s012QuestionSecondChild = "What is " + secondChildFullName + "'s "
				+ Utility.getFromTextProperties("s012Question");
		String s012QuestionMother = "What is " + motherFullName + "'s " + Utility.getFromTextProperties("s012Question");
		...
		String s012SameNameQuestionSecondChild = "Is " + secondChildFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestion");
		String s012SameNameQuestionMother = "Is " + motherFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestion");
		...
		String s014QuestionSecondChild = "Is " + secondChildFullName + " "
				+ Utility.getFromTextProperties("s014Question");
		String s014QuestionMother = "Is " + motherFullName + " " + Utility.getFromTextProperties("s014Question");
		...
		String s026QuestionFirstChild = "What’s" + " " + firstChildFullName + "'s" + " "
				+ Utility.getFromTextProperties("s026Question");
		String s026QuestionMother = "What’s" + " " + motherFullName + "'s" + " "
				+ Utility.getFromTextProperties("s026Question");
		String s026DrawerContent = Utility.getFromTextProperties("s026DrawerContent");
		String s026DrawerHeading = Utility.getFromTextProperties("s026DrawerHeading");
		String s027Question = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s027Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		String s027QuestionMother = "Does " + motherFullName + " " + Utility.getFromTextProperties("s027Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		...
		String s057QuestionMama = "Will " + motherFullName + " " + Utility.getFromTextProperties("s057Question");
		String s057Question2Mama = "Select a type of income " + motherFullName + " "
				+ Utility.getFromTextProperties("s057Question2");
		String s057Question3Mama = "How often does " + motherFullName + " "
				+ Utility.getFromTextProperties("s057Question3");
		...
		String s058QuestionFather = "Does " + fatherFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionSecondChild = "Does " + secondChildFullName + " "
				+ Utility.getFromTextProperties("s058Question") + " " + ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionGrandDaughter = "Does " + grandDaughterFullName + " "
				+ Utility.getFromTextProperties("s058Question") + " " + ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionMama = "Does " + motherFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		...
		String s027QuestionSingleMother = "Does " + motherFullName + " "
				+ Utility.getFromTextProperties("s027QuestionSingle") + " " + ESTTimeZone.getCurrentYear() + "?";
		String s027QuestionSomeOneElseTaxReturn = "Will " + motherFullName + " "
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation1_L(parentRelation, motherFatherInLaw, grandParentRelation, "not applicable",
				"3");
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation1_L(childRelationShip, childRelationShip, brotherRelation, grandChildRelation,
				"4");
		commonMethodPage.clickSaveAndContinueButton();
		...
		// SSN for male
		ExtentTestManager.getTest().info("---------------------SCREEN S012----------------------------");
		commonMethodPage.verifyS012(s012QuestionMother);
		commonMethodPage.clickWithOutSSN();
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutSsnBtn();
		...
		// Marital status
		ExtentTestManager.getTest().info("---------------------SCREEN S026----------------------------");
		commonMethodPage.verifyS026(s026QuestionMother, s026DrawerHeading, s026DrawerContent);
		commonMethodPage.selectMaritalStatus(married);
		commonMethodPage.selectToAddNonAplicantSpouse_S026("Someone else who isn't applying for coverage");
		commonMethodPage.enterDob(fatherAge);
		...
		// Filling Tax
		ExtentTestManager.getTest().info("---------------------SCREEN S027----------------------------");
		commonMethodPage.verifyS027(s027QuestionMother, s027DrawerHeading, s027DrawerContent);
		commonMethodPage.selectIsFilingTax(no);
		commonMethodPage.verifyS027Single2(s027QuestionSingleMother);
		commonMethodPage.selectIsFilingTaxMarriedNotFillingJointlyQuestion2_S027(no);
...
//												ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		// Income Questions
		ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
		commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057QuestionMama);
		commonMethodPage.incomeThisMonth_S057(yes);
		commonMethodPage.verifyS057Question2IncomeType(s057Question2Mama);
		commonMethodPage.selectIncomeType(socialSecurityBenefit);
		commonMethodPage.verifyS057Question3IncomeDuration(s057Question3Mama);
		commonMethodPage.incomePeriod_S057(mamaIncomePeriod);
		commonMethodPage.verifyS057Question4EnterIncome(s057Question4);
		commonMethodPage.enterIncomeAmount(mamaIncomeAmount);
		commonMethodPage.clickSaveAndContinueButton();

		// Expense
		ExtentTestManager.getTest().info("---------------------SCREEN S058----------------------------");
		commonMethodPage.verifyS058(s058QuestionMama);
		commonMethodPage.expenseDecision_S058(no);
		commonMethodPage.clickSaveAndContinueButton();
...
//		Wait.wait5Second();
		...
		commonMethodPage.haveHealthCoverageNow_S078(secondChildFullName);
		commonMethodPage.clickSaveAndContinueButton();
