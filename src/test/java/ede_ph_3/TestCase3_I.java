...
public class TestCase3_I extends BaseTest {
	@Test
	public void testCase3_I() throws Exception {

		ExtentTestManager.createTest("Test case 3.I", "Test case 3.I");
		...
		String individualCoverageHRA = Utility.getValue("individualCoverageHRA");
		String QSEHRA = Utility.getValue("QSEHRA");

		// Get data from testcase3_I.properties
		String state = Utility.getDate_TestCase3_I("state");
		String firstName = Utility.getDate_TestCase3_I("firstName");
		String lastName = Utility.getDate_TestCase3_I("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase3_I("age");
		String streetAddress = Utility.getDate_TestCase3_I("streetAddress");
		String city = Utility.getDate_TestCase3_I("city");
		String zipCode = Utility.getDate_TestCase3_I("zipCode");
		String county = Utility.getDate_TestCase3_I("county");
		String phoneType = Utility.getDate_TestCase3_I("phoneType");
		String SSN = Utility.getDate_TestCase3_I("SSN");
		String spouseSSN = Utility.getDate_TestCase3_I("spouseSSN");
		String relationShip = Utility.getDate_TestCase3_I("relationShip");
		String spouseFirstName = Utility.getDate_TestCase3_I("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase3_I("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase3_I("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase3_I("babyCount");
		String incomeAmount = Utility.getDate_TestCase3_I("incomeAmount");
		String incomeType = Utility.getDate_TestCase3_I("incomeType");
		String employerName = Utility.getDate_TestCase3_I("employerName");
		String incomePeriod = Utility.getDate_TestCase3_I("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase3_I("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase3_I("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase3_I("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase3_I("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase3_I("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase3_I("gotMarried");
		...
		String s069CQuestion = "will " + applicantFullName + " " + Utility.getFromTextProperties("s069CQuestion");
		String s069CQuestion2 = "Which employers offer " + applicantFullName + " "
				+ Utility.getFromTextProperties("s069CQuestion2");
		String ichraStartDateJobA = ESTTimeZone.getPreviousDate("5", "MM/dd/yyyy");
		String ichraEndDateJobA = ESTTimeZone.getAdvanceDate("75", "MM/dd/yyyy");
		String s069EQuestion = Utility.getFromTextProperties("s069EQuestion") + " " + employerName;
		...
		String s069CQuestion2Spouse = "Which employers offer " + spouseFullName + " "
				+ Utility.getFromTextProperties("s069CQuestion2");
		String indivitualStartDate = ESTTimeZone.getPreviousDate("5", "MM/dd/yyyy");
		String indivitualNoticeDate = ESTTimeZone.getPreviousDate("95", "MM/dd/yyyy");
		String indivitualStartDate2 = ESTTimeZone.getPreviousDate("5", "MM/dd/yyyy");
		String indivitualNoticeDate2 = ESTTimeZone.getPreviousDate("95", "MM/dd/yyyy");
		String qsehraNoticeDate = ESTTimeZone.getPreviousDate("30", "MM/dd/yyyy");
		String qsehraStartDate = ESTTimeZone.getStartOfNextMonth("MM/dd/yyyy");
...
//						ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		if (question.contains(applicantFullName)) {
			...
			commonMethodPage.whichEmployerOfferHRA_S069C(employerName);
			flag = 1;
			commonMethodPage.clickSaveAndContinueButton();
		} else {
		...
		commonMethodPage.qsehraStartDate_S069D(qsehraStartDate);
		commonMethodPage.qsehraNoticeDate_S069D(qsehraNoticeDate);

		commonMethodPage.qsehraThroughEmployer_S069D(yes);
		commonMethodPage.qsehraThroughEmployer2_S069D(no);
