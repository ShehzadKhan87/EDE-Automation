...
public class TestCase_01 extends BaseTest{
	...
	public void testCase_01() throws Exception {
		...
		ExtentTestManager.createTest("Family Glitch Partner Test Case 01", "Test case 01");
		...
		String state = Utility.getDate_CR58_TestCase_01("state");
		String firstName = Utility.getDate_CR58_TestCase_01("firstName");
		String lastName = Utility.getDate_CR58_TestCase_01("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_CR58_TestCase_01("age");
		String streetAddress = Utility.getDate_CR58_TestCase_01("streetAddress");
		String city = Utility.getDate_CR58_TestCase_01("city");
		String zipCode = Utility.getDate_CR58_TestCase_01("zipCode");
		String county = Utility.getDate_CR58_TestCase_01("county");
		String phoneNumber = Utility.getDate_CR58_TestCase_01("phoneNumber");
		String phoneType = Utility.getDate_CR58_TestCase_01("phoneType");
		String incomeAmount = Utility.getDate_CR58_TestCase_01("incomeAmount");
		String selfPremiumAmount = Utility.getDate_CR58_TestCase_01("selfOnlyPremiumAmount");
		String familypremiumAmount = Utility.getDate_CR58_TestCase_01("familypremiumAmount");
		String incomeType = Utility.getDate_CR58_TestCase_01("incomeType");
		String employerName = Utility.getDate_CR58_TestCase_01("employerName");
		String incomePeriod = Utility.getDate_CR58_TestCase_01("incomePeriod");
		String relationShip = Utility.getDate_CR58_TestCase_01("relationShip");
		String spouseFirstName = Utility.getDate_CR58_TestCase_01("spouseFirstName");
		String spouseLastName = Utility.getDate_CR58_TestCase_01("spouseLastName");
		String spouseAge = Utility.getDate_CR58_TestCase_01("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_CR58_TestCase_01("EmployerPhone");
		String gotMarried = Utility.getDate_CR58_TestCase_01("gotMarried");
		String daughterFirstName = Utility.getDate_CR58_TestCase_01("daughterFirstName");
		String daughterLastName = Utility.getDate_CR58_TestCase_01("daughterLastName");
		String daughterFullName = daughterFirstName + " " + daughterLastName;
		String daughterAge = Utility.getDate_CR58_TestCase_01("daughterAge");
		String childRelationShip = Utility.getDate_CR58_TestCase_01("childRelationShip");
		String sonFirstName = Utility.getDate_CR58_TestCase_01("sonFirstName");
		String sonLastName = Utility.getDate_CR58_TestCase_01("sonLastName");
		String sonFullName = sonFirstName + " " + sonLastName;
		String sonAge = Utility.getDate_CR58_TestCase_01("sonAge");
		String siblingRelationShip = Utility.getDate_CR58_TestCase_01("siblingRelationShip");
		String plan = Utility.getDate_CR58_TestCase_01("plan");
		String withoutDocument = Utility.getDate_CR58_TestCase_01("withoutDocument");
		String childIncomeAmount = Utility.getDate_CR58_TestCase_01("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_CR58_TestCase_01("anualPredictedAmount");
		String hours = Utility.getDate_CR58_TestCase_01("hours");
		String document = Utility.getDate_CR58_TestCase_01("document");
		String documentType = Utility.getDate_CR58_TestCase_01("documentType");
		String s050OptionPregnant = Utility.getDate_CR58_TestCase_01("s050OptionPregnant");
		String babyCount = Utility.getDate_CR58_TestCase_01("babyCount");
		String coverageEndReason = Utility.getDate_CR58_TestCase_01("coverageEndReason");
		String premiumAmount = Utility.getDate_CR58_TestCase_01("premiumAmount");
		String gainedADependent = Utility.getDate_CR58_TestCase_01("gainedADependent");
		...
		String s038QuestionDaughter1 = "Is " + daughterFullName + " " + Utility.getFromTextProperties("s038Question1");
		String s038QuestionDaughter2 = "Does " + daughterFullName + " " + Utility.getFromTextProperties("s038Question2");
		String s038QuestionSon1 = "Is " + sonFullName + " " + Utility.getFromTextProperties("s038Question1");
		String s038QuestionSon2 = "Does " + sonFullName + " " + Utility.getFromTextProperties("s038Question2");
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S038----------------------------");
		commonMethodPage.verifyS038(s038QuestionDaughter1);
		commonMethodPage.applicantMainPersontakingCare_S038(noneOfThese);
		Wait.wait2Second();
		commonMethodPage.verifyS038(s038QuestionDaughter2);
		commonMethodPage.applicantTakeCareOfChildrenFirst_S038(no);
		Wait.wait2Second();
		commonMethodPage.clickSaveAndContinueButton();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S038----------------------------");
		commonMethodPage.verifyS038(s038QuestionSon1);
		commonMethodPage.applicantMainPersontakingCare_S038(noneOfThese);
		Wait.wait2Second();
		commonMethodPage.verifyS038(s038QuestionSon2);
		commonMethodPage.applicantTakeCareOfChildrenFirst_S038(no);
		Wait.wait2Second();
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.employerOfferextendsTo_S072(daughterFullName);
		commonMethodPage.employerOfferextendsTo_S072(sonFullName);
		Wait.wait2Second();
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.verifyScreen_s071AB_Question(s071ABQuestion);
