...
public class TestCase_10 extends BaseTest {
	...
	public void testCase_10() throws Exception {
		...
		ExtentTestManager.createTest("Family Glitch Partner Test Case 10", "Test case ");
		...
		String weekly = Utility.getValue("weekly");
		...
		// Get data from CR58_TestCase_10.properties

		String state = Utility.getDate_CR58_TestCase_10("state");
		String firstName = Utility.getDate_CR58_TestCase_10("firstName");
		String lastName = Utility.getDate_CR58_TestCase_10("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_CR58_TestCase_10("age");
		String streetAddress = Utility.getDate_CR58_TestCase_10("streetAddress");
		String city = Utility.getDate_CR58_TestCase_10("city");
		String zipCode = Utility.getDate_CR58_TestCase_10("zipCode");
		String county = Utility.getDate_CR58_TestCase_10("county");
		String phoneNumber = Utility.getDate_CR58_TestCase_10("phoneNumber");
		String phoneType = Utility.getDate_CR58_TestCase_10("phoneType");
		String incomeAmount1 = Utility.getDate_CR58_TestCase_10("incomeAmount1");
		String incomeAmount2 = Utility.getDate_CR58_TestCase_10("incomeAmount2");
		String selfPremiumAmount1 = Utility.getDate_CR58_TestCase_10("selfOnlyPremiumAmount1");
		String selfPremiumAmount2 = Utility.getDate_CR58_TestCase_10("selfOnlyPremiumAmount2");
		String familypremiumAmount = Utility.getDate_CR58_TestCase_10("familypremiumAmount");
		String incomeType = Utility.getDate_CR58_TestCase_10("incomeType");
		String employer1Name = Utility.getDate_CR58_TestCase_10("employer1Name");
		String employer2Name = Utility.getDate_CR58_TestCase_10("employer2Name");
		String incomePeriod = Utility.getDate_CR58_TestCase_10("incomePeriod");
		String relationShip = Utility.getDate_CR58_TestCase_10("relationShip");
		String spouseFirstName = Utility.getDate_CR58_TestCase_10("spouseFirstName");
		String spouseLastName = Utility.getDate_CR58_TestCase_10("spouseLastName");
		String spouseAge = Utility.getDate_CR58_TestCase_10("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String Employer1Phone = Utility.getDate_CR58_TestCase_10("Employer1Phone");
		String Employer2Phone = Utility.getDate_CR58_TestCase_10("Employer2Phone");
		...
		String s027Question = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s027Question") + " " + ESTTimeZone.getCurrentYear() + "?";
		...
		String s074Question1 = Utility.getFromTextProperties("s074Question") + " " + employer1Name + " ("
				+ applicantFullName + "'s job).";
		String s074Question2 = Utility.getFromTextProperties("s074Question") + " " + employer2Name + " ("
				+ applicantFullName + "'s job).";
		...
		commonMethodPage.whichEmployerOfferThisCoverage_S071(employer2Name);
		Wait.wait2Second();
		commonMethodPage.clickSaveAndContinueButton();
		...
		Wait.wait2Second();
		commonMethodPage.verifyScreen_s072_Question(s072Question2_2);
		commonMethodPage.employerOfferextendsTo_S072(applicantFullName);
		Wait.wait2Second();
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.enterPhoneNumber(Employer1Phone);
		commonMethodPage.enterPhoneNumberJobB(Employer2Phone);
		Wait.wait2Second();
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.enterSelfPremiumAmount_S073(selfPremiumAmount1);
		commonMethodPage.selectSelfPremiumPeriod_s073(weekly);
		...
		//Job 2
		commonMethodPage.verifyScreen_s073_Question(s073Question_2);
		commonMethodPage.doesEmployerCoverageMeetMinimumValueStandard_S073(yes);
		commonMethodPage.enterSelfPremiumAmount2_S073(selfPremiumAmount2);
		commonMethodPage.selectSelfPremiumPeriod_s073(monthly);
		commonMethodPage.enterFamilyPremiumAmount2_S073(familypremiumAmount);
		commonMethodPage.selectFamilyPremiumPeriod_s073(everyTwoWeek);
