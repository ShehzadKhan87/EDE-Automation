...
public class TestCase_03 extends BaseTest {
	...
	public void testCase_03() throws Exception {
		...
		ExtentTestManager.createTest("Family Glitch TC_03", "Test case 03");
		...
		String aPlanFor = Utility.getValue("aPlanFor");

		// Get data from testcase3_C.properties
		String state = Utility.getDate_CR58_TestCase_03("state");
		String firstName = Utility.getDate_CR58_TestCase_03("firstName");
		String lastName = Utility.getDate_CR58_TestCase_03("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_CR58_TestCase_03("age");
		String streetAddress = Utility.getDate_CR58_TestCase_03("streetAddress");
		String city = Utility.getDate_CR58_TestCase_03("city");
		String zipCode = Utility.getDate_CR58_TestCase_03("zipCode");
		String county = Utility.getDate_CR58_TestCase_03("county");
		String phoneNumber = Utility.getDate_CR58_TestCase_03("phoneNumber");
		String phoneType = Utility.getDate_CR58_TestCase_03("phoneType");
		String domesticPartnerFirstName = Utility.getDate_CR58_TestCase_03("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_CR58_TestCase_03("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_CR58_TestCase_03("domesticPartnerAge");
		String incomeAmount = Utility.getDate_CR58_TestCase_03("incomeAmount");
		String selfPremiumAmount = Utility.getDate_CR58_TestCase_03("selfOnlyPremiumAmount");
		String familyPremiumAmount = Utility.getDate_CR58_TestCase_03("familyPremiumAmount");
		String incomeType = Utility.getDate_CR58_TestCase_03("incomeType");
		String employer1Name = Utility.getDate_CR58_TestCase_03("employer1Name");
		String employer2Name = Utility.getDate_CR58_TestCase_03("employer2Name");
		String incomePeriod = Utility.getDate_CR58_TestCase_03("incomePeriod");
		String domesticPartnerIncomeAmount = Utility.getDate_CR58_TestCase_03("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_CR58_TestCase_03("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_CR58_TestCase_03("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_CR58_TestCase_03("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_CR58_TestCase_03("relationShip");
		String spouseFirstName = Utility.getDate_CR58_TestCase_03("spouseFirstName");
		String spouseLastName = Utility.getDate_CR58_TestCase_03("spouseLastName");
		String spouseAge = Utility.getDate_CR58_TestCase_03("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_CR58_TestCase_03("EmployerPhone");
		String gotMarried = Utility.getDate_CR58_TestCase_03("gotMarried");
		String childFirstName = Utility.getDate_CR58_TestCase_03("childFirstName");
		String childLastName = Utility.getDate_CR58_TestCase_03("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_CR58_TestCase_03("childAge");
		String childRelationShip = Utility.getDate_CR58_TestCase_03("childRelationShip");
		String plan = Utility.getDate_CR58_TestCase_03("plan");
		String withoutDocument = Utility.getDate_CR58_TestCase_03("withoutDocument");
		String childIncomeAmount = Utility.getDate_CR58_TestCase_03("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_CR58_TestCase_03("anualPredictedAmount");
		String hours = Utility.getDate_CR58_TestCase_03("hours");
		String document = Utility.getDate_CR58_TestCase_03("document");
		String documentType = Utility.getDate_CR58_TestCase_03("documentType");
		String s050OptionPregnant = Utility.getDate_CR58_TestCase_03("s050OptionPregnant");
		String babyCount = Utility.getDate_CR58_TestCase_03("babyCount");
		String coverageEndReason = Utility.getDate_CR58_TestCase_03("coverageEndReason");
		String premiumAmount = Utility.getDate_CR58_TestCase_03("premiumAmount");
		String gainedADependent = Utility.getDate_CR58_TestCase_03("gainedADependent");
		...
		String s074Question = Utility.getFromTextProperties("s074Question") + " " + employer1Name + " ("
				+ applicantFullName + "'s job).";
		String s074QuestionChild = Utility.getFromTextProperties("s074Question") + " " + employer2Name + " ("
				+ childFullName + "'s job).";
		String s074QuestionSpouse = Utility.getFromTextProperties("s074Question") + " "
				+ employer1Name + " (" + spouseFullName + "'s job).";
		...
		String s072Question2 = "Does " + employer1Name + " " + Utility.getFromTextProperties("s072Question2");
		String s073Question = "Do the plans offered by " + employer1Name + " " + Utility.getFromTextProperties("s073Question");
		...
		commonMethodPage.verifyS057Question3IncomeDuration(s057Question3Child);
		commonMethodPage.incomePeriod_S057(incomePeriod);
		commonMethodPage.verifyS057Question4EnterIncome(s057Question4);
		commonMethodPage.enterIncomeAmount(childIncomeAmount);
		commonMethodPage.clickSaveAndContinueButton();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S074----------------------------");
		commonMethodPage.verifyS074(s074QuestionChild);
		commonMethodPage.enterPhoneNumber(EmployerPhone);
		commonMethodPage.clickSaveAndContinueButton();
