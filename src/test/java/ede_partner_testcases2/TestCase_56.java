package ede_partner_testcases2;
...
public class TestCase_56 extends BaseTest {
	@Test
	public void testCase_56() throws Exception {

		ExtentTestManager.createTest("Test case 56", "Test case 56");
		...
		String anualPredictedAmount = Utility.getValue("anualPredictedAmount");
		...
		String state = Utility.getDate_TestCase_56("state");
		String firstName = Utility.getDate_TestCase_56("firstName");
		String lastName = Utility.getDate_TestCase_56("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_56("age");
		String streetAddress = Utility.getDate_TestCase_56("streetAddress");
		String city = Utility.getDate_TestCase_56("city");
		String zipCode = Utility.getDate_TestCase_56("zipCode");
		String county = Utility.getDate_TestCase_56("county");
		String phoneNumber = Utility.getDate_TestCase_56("phoneNumber");
		String phoneType = Utility.getDate_TestCase_56("phoneType");
		String SSN = Utility.getDate_TestCase_56("SSN");
		String spouseSSN = Utility.getDate_TestCase_56("spouseSSN");
		String relationShip = Utility.getDate_TestCase_56("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_56("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_56("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase_56("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase_56("babyCount");
		String incomeAmount = Utility.getDate_TestCase_56("incomeAmount");
		String incomeType = Utility.getDate_TestCase_56("incomeType");
		String employerName = Utility.getDate_TestCase_56("employerName");
		String incomePeriod = Utility.getDate_TestCase_56("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase_56("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase_56("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase_56("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase_56("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_56("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_56("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase_56("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase_56("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase_56("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase_56("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase_56("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase_56("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase_56("childRelationShip");
		String plan = Utility.getDate_TestCase_56("plan");
		String brotherRelation = Utility.getDate_TestCase_56("brotherRelation");
		String firstChildSSN = Utility.getDate_TestCase_56("firstChildSSN");
		String secondChildSSN = Utility.getDate_TestCase_56("secondChildSSN");
		String expenseAmount = Utility.getDate_TestCase_56("expenseAmount");
		String coverageName = Utility.getDate_TestCase_56("coverageName");
		String policyNumber = Utility.getDate_TestCase_56("policyNumber");
		String coverageEndReason = Utility.getDate_TestCase_56("coverageEndReason");
		String spouseAge = Utility.getDate_TestCase_56("spouseAge");
		String otherStreetAddress = Utility.getDate_TestCase_56("otherStreetAddress");
		String otherCity = Utility.getDate_TestCase_56("otherCity");
		String otherZipCode = Utility.getDate_TestCase_56("otherZipCode");
		String otherCounty = Utility.getDate_TestCase_56("otherCounty");
		String otherState = Utility.getDate_TestCase_56("otherState");
		String otherAddress = Utility.getDate_TestCase_56("otherAddress");
		String tribeIncomeAmount = Utility.getDate_TestCase_56("tribeIncomeAmount");
		...
		String s057QuestionDaughter = "Will " + secondChildFullName + " "
		...
		commonMethodPage.selectSitutionHouseHold_S050A(incarcerated);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.whoIsAmericanAlaskan_S052(spouseFullName);
		commonMethodPage.whoIsAmericanAlaskan_S052(firstChildFullName);
		commonMethodPage.whoIsAmericanAlaskan_S052(secondChildFullName);
		commonMethodPage.clickSaveAndContinueButton();

		// Who is incarcerated
		ExtentTestManager.getTest().info("---------------------SCREEN S094----------------------------");
		commonMethodPage.verifyS094();
		commonMethodPage.whoIsIncarcerated_S094(secondChildFullName);
		commonMethodPage.incarceratedPendingDisposition_S094_P1(yes);
		commonMethodPage.clickSaveAndContinueButton();
