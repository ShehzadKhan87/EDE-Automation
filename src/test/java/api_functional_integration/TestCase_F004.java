...
public class TestCase_F004 extends BaseTest {

	@Test
	public void testCase_F004() throws Exception {

		ExtentTestManager.createTest("Test case F004", "Test case F004");
		...
		String aptcAmount = Utility.getData_TestCase_F004("aptcAmount");
...
//										ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.howMuchFromYourLowerPremium("Some");
		commonMethodPage.enterAptcAmount(aptcAmount);
		commonMethodPage.clickSaveAndContinueButton();
