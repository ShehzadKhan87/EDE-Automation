...
public class TestCase_181 extends BaseTest {
	@Test
	public void testCase_181() throws Exception {

		ExtentTestManager.createTest("Test case 181", "Test case 181");
		...
		String state = Utility.getDate_TestCase181("state");
		String firstName = Utility.getDate_TestCase181("firstName");
		String lastName = Utility.getDate_TestCase181("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase181("age");
		String streetAddress = Utility.getDate_TestCase181("streetAddress");
		String city = Utility.getDate_TestCase181("city");
		String zipCode = Utility.getDate_TestCase181("zipCode");
		String county = Utility.getDate_TestCase181("county");
		String phoneNumber = Utility.getDate_TestCase181("phoneNumber");
		String phoneType = Utility.getDate_TestCase181("phoneType");
		String unrelatedPersonFirstName = Utility.getDate_TestCase181("unrelatedPersonFirstName");
		String unrelatedPersonLastName = Utility.getDate_TestCase181("unrelatedPersonLastName");
		String unrelatedPersonFullName = unrelatedPersonFirstName + " " + unrelatedPersonLastName;
		String unrelatedPersonAge = Utility.getDate_TestCase181("unrelatedPersonAge");
		String incomeAmount = Utility.getDate_TestCase181("incomeAmount");
		String incomeType = Utility.getDate_TestCase181("incomeType");
		String employerName = Utility.getDate_TestCase181("employerName");
		String incomePeriod = Utility.getDate_TestCase181("incomePeriod");
		String unrelatedPersonIncomeAmount = Utility.getDate_TestCase181("unrelatedPersonIncomeAmount");
		String unrelatedPersonIncomeType = Utility.getDate_TestCase181("unrelatedPersonIncomeType");
		String unrelatedPersonEmployerName = Utility.getDate_TestCase181("unrelatedPersonEmployerName");
		String unrelatedPersonIncomePeriod = Utility.getDate_TestCase181("unrelatedPersonIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase181("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase181("gotMarried");
		String childFirstName = Utility.getDate_TestCase181("childFirstName");
		String childLastName = Utility.getDate_TestCase181("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase181("childAge");
		String childRelationShip = Utility.getDate_TestCase181("childRelationShip");
		String plan = Utility.getDate_TestCase181("plan");
		String withoutDocument = Utility.getDate_TestCase181("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase181("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase181("anualPredictedAmount");
		String hours = Utility.getDate_TestCase181("hours");
		String document = Utility.getDate_TestCase181("document");
		String documentType = Utility.getDate_TestCase181("documentType");
		String s050OptionPregnant = Utility.getDate_TestCase181("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase181("babyCount");
		String coverageEndReason = Utility.getDate_TestCase181("coverageEndReason");
		String premiumAmount = Utility.getDate_TestCase181("premiumAmount");
		String otherAddress = Utility.getDate_TestCase181("otherAddress");
		String otherStreetAddress = Utility.getDate_TestCase181("otherStreetAddress");
		String otherCity = Utility.getDate_TestCase181("otherCity");
		String otherZipCode = Utility.getDate_TestCase181("otherZipCode");
		String otherCounty = Utility.getDate_TestCase181("otherCounty");
		String otherState = Utility.getDate_TestCase181("otherState");
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation3G_S27(parentRelation, otherUnRelatedRelation, "Not Applicable",
				"not applicable", "2");
		commonMethodPage.clickSaveAndContinueButton();
