...
public class TestCase_98 extends BaseTest {
	@Test
	public void testCase_98() throws Exception {

		ExtentTestManager.createTest("Test case 98", "Test case 98");
		...
		// Get data from testcase_98.properties
		String state = Utility.getDate_TestCase_98("state");
		String firstName = Utility.getDate_TestCase_98("firstName");
		String lastName = Utility.getDate_TestCase_98("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_98("age");
		String streetAddress = Utility.getDate_TestCase_98("streetAddress");
		String city = Utility.getDate_TestCase_98("city");
		String zipCode = Utility.getDate_TestCase_98("zipCode");
		String county = Utility.getDate_TestCase_98("county");
		String phoneNumber = Utility.getDate_TestCase_98("phoneNumber");
		String phoneType = Utility.getDate_TestCase_98("phoneType");
		String SSN = Utility.getDate_TestCase_98("SSN");
		String spouseSSN = Utility.getDate_TestCase_98("spouseSSN");
		String relationShip = Utility.getDate_TestCase_98("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_98("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_98("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase_98("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase_98("babyCount");
		String incomeAmount = Utility.getDate_TestCase_98("incomeAmount");
		String incomeType = Utility.getDate_TestCase_98("incomeType");
		String employerName = Utility.getDate_TestCase_98("employerName");
		String incomePeriod = Utility.getDate_TestCase_98("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase_98("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase_98("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase_98("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase_98("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_98("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_98("gotMarried");
		String childFirstName = Utility.getDate_TestCase_98("childFirstName");
		String childLastName = Utility.getDate_TestCase_98("childLastName");
		String childDob = ESTTimeZone.getPreviousDate("75", "MM/dd/yyyy");
		String childRelationShip = Utility.getDate_TestCase_98("childRelationShip");
		String plan = Utility.getDate_TestCase_98("plan");
