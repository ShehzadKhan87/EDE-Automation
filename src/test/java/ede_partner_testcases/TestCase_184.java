...
public class TestCase_184 extends BaseTest {
	@Test
	public void testCase_184() throws Exception {

		ExtentTestManager.createTest("Test case 184", "Test case 184");
		...
		// Get data from testcase_184.properties
		String state = Utility.getDate_TestCase184("state");
		String firstName = Utility.getDate_TestCase184("firstName");
		String lastName = Utility.getDate_TestCase184("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase184("age");
		String streetAddress = Utility.getDate_TestCase184("streetAddress");
		String city = Utility.getDate_TestCase184("city");
		String zipCode = Utility.getDate_TestCase184("zipCode");
		String county = Utility.getDate_TestCase184("county");
		String phoneNumber = Utility.getDate_TestCase184("phoneNumber");
		String phoneType = Utility.getDate_TestCase184("phoneType");
		String SSN = Utility.getDate_TestCase184("SSN");
		String spouseSSN = Utility.getDate_TestCase184("spouseSSN");
		String relationShip = Utility.getDate_TestCase184("relationShip");
		String spouseFirstName = Utility.getDate_TestCase184("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase184("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase184("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase184("babyCount");
		String incomeAmount = Utility.getDate_TestCase184("incomeAmount");
		String incomeType = Utility.getDate_TestCase184("incomeType");
		String employerName = Utility.getDate_TestCase184("employerName");
		String incomePeriod = Utility.getDate_TestCase184("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase184("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase184("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase184("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase184("spouseIncomePeriod");
		String firstChildIncomeAmount = Utility.getDate_TestCase184("firstChildIncomeAmount");
		String firstChildIncomeType = Utility.getDate_TestCase184("firstChildIncomeType");
		String firstChildEmployerName = Utility.getDate_TestCase184("firstChildEmployerName");
		String firstChildIncomePeriod = Utility.getDate_TestCase184("firstChildIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase184("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase184("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase184("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase184("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase184("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase184("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase184("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase184("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase184("childRelationShip");
		String remove = Utility.getDate_TestCase184("remove") + " " + spouseFullName + " "
				+ Utility.getDate_TestCase184("fromApplication");
		String brotherRelation = Utility.getDate_TestCase184("brotherRelation");
		String divorce = Utility.getDate_TestCase184("divorce");
		String divorceDate = ESTTimeZone.getCurrentDate("MM/dd/yyyy");
		String incomeAmountCIC = Utility.getDate_TestCase184("incomeAmountCIC");
		...
		String s010BQuestion = "Remove " + spouseFullName + ", " + Utility.getFromTextProperties("s010BQuestion");
...
//								ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		// removeSomeOneDrawerHeading,
		// medicaidDrawerContent, notIncludeDrawerContent, removeSomeOneDrawerContent);
		commonMethodPage.selectCoverage_S010(firstChildFirstName, no);
		Wait.wait2Second();
		commonMethodPage.selectCoverage_S010(secondChildFirstName, no);
		commonMethodPage.clickSaveAndContinueScrolled();
		...
		Wait.wait2Second();
		commonMethodPage.verifyS010A(s010AQuestion, s010ADrawerHeading, s010ADrawerContent);
		commonMethodPage.selectToRemovePerson(spouseFullName);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.reasonOfRemove_S010B(divorce);
		commonMethodPage.s046EnterDate(divorceDate);
		commonMethodPage.clickSaveAndContinueButton();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
		commonMethodPage.enterIncomeAmount(incomeAmountCIC);
		commonMethodPage.clickSaveAndContinueButton();
