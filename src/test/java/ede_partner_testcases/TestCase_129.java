...
public class TestCase_129 extends BaseTest {
	@Test
	public void testCase_129() throws Exception {

		ExtentTestManager.createTest("Test case 129", "Test case 129");
		...
		String state = Utility.getDate_TestCase_129("state");
		String firstName = Utility.getDate_TestCase_129("firstName");
		String lastName = Utility.getDate_TestCase_129("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_129("age");
		String streetAddress = Utility.getDate_TestCase_129("streetAddress");
		String city = Utility.getDate_TestCase_129("city");
		String zipCode = Utility.getDate_TestCase_129("zipCode");
		String county = Utility.getDate_TestCase_129("county");
		String phoneNumber = Utility.getDate_TestCase_129("phoneNumber");
		String phoneType = Utility.getDate_TestCase_129("phoneType");
		String SSN = Utility.getDate_TestCase_129("SSN");
		String spouseSSN = Utility.getDate_TestCase_129("spouseSSN");
		String invalidSSN = Utility.getDate_TestCase_129("invalidSSN");
		String childSSN = Utility.getDate_TestCase_129("childSSN");
		String relationShip = Utility.getDate_TestCase_129("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_129("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_129("spouseLastName");
		...
		String babyCount = Utility.getDate_TestCase_129("babyCount");
		String incomeAmount = Utility.getDate_TestCase_129("incomeAmount");
		String incomeType = Utility.getDate_TestCase_129("incomeType");
		String employerName = Utility.getDate_TestCase_129("employerName");
		String incomePeriod = Utility.getDate_TestCase_129("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase_129("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase_129("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase_129("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase_129("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_129("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_129("gotMarried");
		String childFirstName = Utility.getDate_TestCase_129("childFirstName");
		String childLastName = Utility.getDate_TestCase_129("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_129("childAge");
		String childRelationShip = Utility.getDate_TestCase_129("childRelationShip");
		String plan = Utility.getDate_TestCase_129("plan");
		String withoutDocument = Utility.getDate_TestCase_129("withoutDocument");
		String expenseAmount = Utility.getDate_TestCase_129("expenseAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_129("anualPredictedAmount");
		...
		commonMethodPage.enterInvalidSSN(invalidSSN);
		commonMethodPage.verifySsnError(invalidSsnError);
