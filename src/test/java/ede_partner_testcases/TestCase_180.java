...
public class TestCase_180 extends BaseTest {
	@Test
	public void estCase_180() throws Exception {

		ExtentTestManager.createTest("Test case 180", "Test case 180");
		...
		String state = Utility.getDate_TestCase180("state");
		String firstName = Utility.getDate_TestCase180("firstName");
		String lastName = Utility.getDate_TestCase180("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase180("age");
		String streetAddress = Utility.getDate_TestCase180("streetAddress");
		String city = Utility.getDate_TestCase180("city");
		String zipCode = Utility.getDate_TestCase180("zipCode");
		String county = Utility.getDate_TestCase180("county");
		String phoneNumber = Utility.getDate_TestCase180("phoneNumber");
		String phoneType = Utility.getDate_TestCase180("phoneType");
		String document = Utility.getDate_TestCase180("document");
		String documentType = Utility.getDate_TestCase180("documentType");
		String incomeAmount = Utility.getDate_TestCase180("incomeAmount");
		String incomeType = Utility.getDate_TestCase180("incomeType");
		String employerName = Utility.getDate_TestCase180("employerName");
		String incomePeriod = Utility.getDate_TestCase180("incomePeriod");
		String EmployerPhone = Utility.getDate_TestCase180("EmployerPhone");
