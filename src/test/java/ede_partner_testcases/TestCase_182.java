...
public class TestCase_182 extends BaseTest {
	@Test
	public void testCase_182() throws Exception {

		ExtentTestManager.createTest("Test case 182", "Test case 182");
		...
		// Get data from testcase182.properties
		String state = Utility.getDate_TestCase182("state");
		String firstName = Utility.getDate_TestCase182("firstName");
		String lastName = Utility.getDate_TestCase182("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase182("age");
		String streetAddress = Utility.getDate_TestCase182("streetAddress");
		String city = Utility.getDate_TestCase182("city");
		String zipCode = Utility.getDate_TestCase182("zipCode");
		String county = Utility.getDate_TestCase182("county");
		String phoneNumber = Utility.getDate_TestCase182("phoneNumber");
		String phoneType = Utility.getDate_TestCase182("phoneType");
		String relationShip = Utility.getDate_TestCase182("relationShip");
		String spouseFirstName = Utility.getDate_TestCase182("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase182("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase182("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase182("babyCount");
		String incomeAmount = Utility.getDate_TestCase182("incomeAmount");
		String incomeType = Utility.getDate_TestCase182("incomeType");
		String employerName = Utility.getDate_TestCase182("employerName");
		String incomePeriod = Utility.getDate_TestCase182("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase182("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase182("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase182("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase182("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase182("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase182("gotMarried");
		String childFirstName = Utility.getDate_TestCase182("childFirstName");
		String childLastName = Utility.getDate_TestCase182("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase182("childAge");
		String childRelationShip = Utility.getDate_TestCase182("childRelationShip");
		String spouseAge = Utility.getDate_TestCase182("spouseAge");
		String spouseIncomeAmountCIC = Utility.getDate_TestCase182("spouseIncomeAmountCIC");
...
//				ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.verifyS057Question3IncomeDuration(s057Question3Spouse);
		commonMethodPage.verifyS057Question4EnterIncome(s057Question4);
		commonMethodPage.enterIncomeAmount(spouseIncomeAmountCIC);
		commonMethodPage.clickSaveAndContinueButton();
		Wait.wait3Second();
		// Expense
		ExtentTestManager.getTest().info("---------------------SCREEN S058----------------------------");
