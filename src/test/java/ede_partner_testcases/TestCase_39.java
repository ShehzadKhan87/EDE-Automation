...
public class TestCase_39 extends BaseTest {
	@Test
	public void testCase_39() throws Exception {
		...
		String state = Utility.getDate_TestCase39("state");
		String firstName = Utility.getDate_TestCase39("firstName");
		String lastName = Utility.getDate_TestCase39("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase39("age");
		String streetAddress = Utility.getDate_TestCase39("streetAddress");
		String city = Utility.getDate_TestCase39("city");
		String zipCode = Utility.getDate_TestCase39("zipCode");
		String county = Utility.getDate_TestCase39("county");
		String phoneNumber = Utility.getDate_TestCase39("phoneNumber");
		String phoneType = Utility.getDate_TestCase39("phoneType");
		String relationShip = Utility.getDate_TestCase39("relationShip");
		String daughterFirstName = Utility.getDate_TestCase39("daughterFirstName");
		String daughterLastName = Utility.getDate_TestCase39("daughterLastName");
		String daughterFullName = daughterFirstName + " " + daughterLastName;
		String daughterAge = Utility.getDate_TestCase39("daughterAge");
		String incomeAmount = Utility.getDate_TestCase39("incomeAmount");
		String incomeType = Utility.getDate_TestCase39("incomeType");
		String employerName = Utility.getDate_TestCase39("employerName");
		String incomePeriod = Utility.getDate_TestCase39("incomePeriod");
		String domesticPartnerIncomeAmount = Utility.getDate_TestCase39("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase39("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase39("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase39("domesticPartnerIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase39("EmployerPhone");
		String domesticPartnerFirstName = Utility.getDate_TestCase39("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase39("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase39("domesticPartnerAge");
		String sonFirstName = Utility.getDate_TestCase39("sonFirstName");
		String sonLastName = Utility.getDate_TestCase39("sonLastName");
		String sonFullName = sonFirstName + " " + sonLastName;
		String sonAge = Utility.getDate_TestCase39("sonAge");
		String childRelationShip = Utility.getDate_TestCase39("childRelationShip");
		String plan = Utility.getDate_TestCase39("plan");
		String brotherRelation = Utility.getDate_TestCase39("brotherRelation");
		String otherAddress = Utility.getDate_TestCase39("otherAddress");
		String otherStreetAddress = Utility.getDate_TestCase39("otherStreetAddress");
		String otherCity = Utility.getDate_TestCase39("otherCity");
		String otherZipCode = Utility.getDate_TestCase39("otherZipCode");
		String otherCounty = Utility.getDate_TestCase39("otherCounty");
		String otherState = Utility.getDate_TestCase39("otherState");
		...
		String s012QuestionFirstChild = "What is " + domesticPartnerFullName + "'s "
				+ Utility.getFromTextProperties("s012Question");
		String s012QuestionSecondChild = "What is " + sonFullName + "'s "
				+ Utility.getFromTextProperties("s012Question");
		String s012SameNameQuestion = "Is " + applicantFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestion");
		String s012SameNameQuestionFirstChild = "Is " + domesticPartnerFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestion");
		String s012SameNameQuestionSecondChild = "Is " + sonFullName + " "
		...
		String s014QuestionSecondChild = "Is " + sonFullName + " " + Utility.getFromTextProperties("s014Question");
		...
		String s026QuestionFirstChild = "What�s" + " " + domesticPartnerFullName + "'s" + " "
				+ Utility.getFromTextProperties("s026Question");
		...
		commonMethodPage.enterDob(sonAge);
		commonMethodPage.enterFirstName(sonFirstName);
		commonMethodPage.enterLastName(sonLastName);
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation3G_S27(brotherRelation, "not applicable", "not applicable", "not applicable",
				"1");
		commonMethodPage.clickSaveAndContinueButton();
		...
		// Filling Tax
		ExtentTestManager.getTest().info("---------------------SCREEN S027----------------------------");
		commonMethodPage.verifyS027(s027QuestionDaughter, s027DrawerHeading, s027DrawerContent);
		commonMethodPage.selectIsFilingTax(no);
		commonMethodPage.verifyS027QuestionSomeOneElseTaxReturn(s027QuestionDependentDaughter);
		...
		commonMethodPage.selectRelationS28_Item92(parentRelation);
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation3G_S27(parentRelation, domesticPartner, "not applicable", "not applicable", "2");
		commonMethodPage.clickSaveAndContinueButton();
...
//										ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.incomeThisMonth_S057(yes);
		commonMethodPage.verifyS057Question2IncomeType(s057Question2DomesticPartner);
		commonMethodPage.selectIncomeType(domesticPartnerIncomeType);
		commonMethodPage.enterEmployerName(domesticPartnerEmployerName);
		commonMethodPage.verifyS057Question3IncomeDuration(s057Question3DomesticPartner);
		commonMethodPage.incomePeriod_S057(domesticPartnerIncomePeriod);
		commonMethodPage.verifyS057Question4EnterIncome(s057Question4);
		commonMethodPage.enterIncomeAmount(domesticPartnerIncomeAmount);
		commonMethodPage.clickSaveAndContinueButton();
...
//								ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S074----------------------------");
		commonMethodPage.verifyS074(s074QuestionDomesticPartner);
		commonMethodPage.enterPhoneNumber(EmployerPhone);
		commonMethodPage.clickSaveAndContinueButton();
