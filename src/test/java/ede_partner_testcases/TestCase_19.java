...
public class TestCase_19 extends BaseTest {
	...
	public void testCase_19() throws Exception {
		...
		ExtentTestManager.createTest("Test case 19", "Test case 19");
		...
		String otherRelative = Utility.getValue("otherRelative");

		// Get data from testcase18.properties
		String state = Utility.getDate_TestCase_19("state");
		String firstName = Utility.getDate_TestCase_19("firstName");
		String lastName = Utility.getDate_TestCase_19("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_19("age");
		String streetAddress = Utility.getDate_TestCase_19("streetAddress");
		String city = Utility.getDate_TestCase_19("city");
		String zipCode = Utility.getDate_TestCase_19("zipCode");
		String county = Utility.getDate_TestCase_19("county");
		String phoneNumber = Utility.getDate_TestCase_19("phoneNumber");
		String phoneType = Utility.getDate_TestCase_19("phoneType");
		String SSN = Utility.getDate_TestCase_19("SSN");
		String spouseSSN = Utility.getDate_TestCase_19("spouseSSN");
		String relationShip = Utility.getDate_TestCase_19("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_19("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_19("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase_19("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase_19("babyCount");
		String incomeAmount = Utility.getDate_TestCase_19("incomeAmount");
		String incomeType = Utility.getDate_TestCase_19("incomeType");
		String employerName = Utility.getDate_TestCase_19("employerName");
		String incomePeriod = Utility.getDate_TestCase_19("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase_19("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase_19("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase_19("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase_19("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_19("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_19("gotMarried");
		String nephewFirstName = Utility.getDate_TestCase_19("nephewFirstName");
		String nephewLastName = Utility.getDate_TestCase_19("nephewLastName");
		String nephewFullName = nephewFirstName + " " + nephewLastName;
		String nephewAge = Utility.getDate_TestCase_19("nephewAge");
		String otherRelativeFirstName = Utility.getDate_TestCase_19("otherRelativeFirstName");
		String otherRelativeLastName = Utility.getDate_TestCase_19("otherRelativeLastName");
		String otherRelativeFullName = otherRelativeFirstName + " " + otherRelativeLastName;
		String otherRelativeAge = Utility.getDate_TestCase_19("otherRelativeAge");
		String plan = Utility.getDate_TestCase_19("plan");
		String parentRelation = Utility.getDate_TestCase_19("parentRelation");
		...
		String s012QuestionOtherRelative = "What is " + otherRelativeFullName + "'s "
		...
		String s014QuestionOtherRelative = "Is " + otherRelativeFullName + " "
				+ Utility.getFromTextProperties("s014Question");
		String s014QuestionNiece = "Is " + otherRelativeFullName + " " + Utility.getFromTextProperties("s014Question");
		...
		String s057QuestionOtherRelative = "Will " + otherRelativeFullName + " "
				+ Utility.getFromTextProperties("s057Question");
		String s057QuestionNeice = "Will " + otherRelativeFullName + " "
				+ Utility.getFromTextProperties("s057Question");
		...
		String s058Question = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionNeice = "Does " + otherRelativeFullName + " " + Utility.getFromTextProperties("s058Question")
				+ " " + ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionNephew = "Does " + nephewFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionOtherRelative = "Does " + otherRelativeFullName + " "
		...
		commonMethodPage.enterDob(otherRelativeAge);
		commonMethodPage.enterFirstName(otherRelativeFirstName);
		commonMethodPage.enterLastName(otherRelativeLastName);
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation3G_S27(otherRelative, otherRelative, "not applicable", "not applicable", "1");
		commonMethodPage.clickSaveAndContinueButton();
		...
		// P4 income
		ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
		commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057QuestionOtherRelative);
		commonMethodPage.incomeThisMonth_S057(no);
		commonMethodPage.clickSaveAndContinueButton();
		Wait.wait3Second();
		ExtentTestManager.getTest().info("---------------------SCREEN S058----------------------------");
		commonMethodPage.verifyS058(s058QuestionOtherRelative);
		commonMethodPage.expenseDecision_S058(no);
		commonMethodPage.clickSaveAndContinueButton();
		Wait.wait3Second();
		ExtentTestManager.getTest().info("---------------------SCREEN S059----------------------------");
		...
		commonMethodPage.haveHealthCoverageNow_S078(otherRelativeFullName);
		commonMethodPage.clickSaveAndContinueButton();
