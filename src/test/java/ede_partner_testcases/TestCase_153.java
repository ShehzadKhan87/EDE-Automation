...
public class TestCase_153 extends BaseTest {
	@Test
	public void testCase_153() throws Exception {

		ExtentTestManager.createTest("Test case 153", "Test case 153");
		...
		// Get data from testcase153.properties
		String state = Utility.getData_TestCase153("state");
		String firstName = Utility.getData_TestCase153("firstName");
		String lastName = Utility.getData_TestCase153("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getData_TestCase153("age");
		String streetAddress = Utility.getData_TestCase153("streetAddress");
		String city = Utility.getData_TestCase153("city");
		String zipCode = Utility.getData_TestCase153("zipCode");
		String county = Utility.getData_TestCase153("county");
		String phoneNumber = Utility.getData_TestCase153("phoneNumber");
		String phoneType = Utility.getData_TestCase153("phoneType");
		String relationShip = Utility.getData_TestCase153("relationShip");
		String spouseFirstName = Utility.getData_TestCase153("spouseFirstName");
		String spouseLastName = Utility.getData_TestCase153("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getData_TestCase153("s050OptionPregnant");
		String babyCount = Utility.getData_TestCase153("babyCount");
		String incomeAmount = Utility.getData_TestCase153("incomeAmount");
		String incomeType = Utility.getData_TestCase153("incomeType");
		String employerName = Utility.getData_TestCase153("employerName");
		String incomePeriod = Utility.getData_TestCase153("incomePeriod");
		String spouseIncomeAmount = Utility.getData_TestCase153("spouseIncomeAmount");
		String spouseIncomeType = Utility.getData_TestCase153("spouseIncomeType");
		String spouseEmployerName = Utility.getData_TestCase153("spouseEmployerName");
		String spouseIncomePeriod = Utility.getData_TestCase153("spouseIncomePeriod");
		String EmployerPhone = Utility.getData_TestCase153("EmployerPhone");
		String gotMarried = Utility.getData_TestCase153("gotMarried");
		String firstChildFirstName = Utility.getData_TestCase153("firstChildFirstName");
		String firstChildLastName = Utility.getData_TestCase153("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getData_TestCase153("firstChildAge");
		String secondChildFirstName = Utility.getData_TestCase153("secondChildFirstName");
		String secondChildLastName = Utility.getData_TestCase153("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getData_TestCase153("secondChildAge");
		String thirdChildFirstName = Utility.getData_TestCase153("thirdChildFirstName");
		String thirdChildLastName = Utility.getData_TestCase153("thirdChildLastName");
		String thirdChildFullName = thirdChildFirstName + " " + thirdChildLastName;
		String thirdChildAge = Utility.getData_TestCase153("thirdChildAge");
		String childRelationShip = Utility.getData_TestCase153("childRelationShip");
		String plan = Utility.getData_TestCase153("plan");
		String brotherRelation = Utility.getData_TestCase153("brotherRelation");
		String firstChildIncomeAmount = Utility.getData_TestCase153("firstChildIncomeAmount");
		String firstChildIncomeType = Utility.getData_TestCase153("firstChildIncomeType");
		String firstChildEmployerName = Utility.getData_TestCase153("firstChildEmployerName");
		String firstChildIncomePeriod = Utility.getData_TestCase153("firstChildIncomePeriod");
		String ichraAmount = Utility.getData_TestCase153("ichraAmount");
		String ichraPeriod = Utility.getData_TestCase153("ichraPeriod");
		String ichraAmountFirstChild = Utility.getData_TestCase153("ichraAmountFirstChild");
		String ichraPeriodFirstChild = Utility.getData_TestCase153("ichraPeriodFirstChild");
		String premiumAmount = Utility.getData_TestCase153("premiumAmount");
...
//										ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.CoverageThroughJobStartingNextMonth_S070(secondChildFullName);
