...
public class TestCase_171 extends BaseTest {
	...
	public void testCase_171() throws Exception {
		...
		ExtentTestManager.createTest("Test case 171", "Test case 171");
		...
		String state = Utility.getDate_TestCase171("state");
		String firstName = Utility.getDate_TestCase171("firstName");
		String lastName = Utility.getDate_TestCase171("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase171("age");
		String streetAddress = Utility.getDate_TestCase171("streetAddress");
		String city = Utility.getDate_TestCase171("city");
		String zipCode = Utility.getDate_TestCase171("zipCode");
		String county = Utility.getDate_TestCase171("county");
		String phoneNumber = Utility.getDate_TestCase171("phoneNumber");
		String phoneType = Utility.getDate_TestCase171("phoneType");
		String SSN = Utility.getDate_TestCase171("SSN");
		String spouseSSN = Utility.getDate_TestCase171("spouseSSN");
		String relationShip = Utility.getDate_TestCase171("relationShip");
		String spouseFirstName = Utility.getDate_TestCase171("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase171("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase171("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase171("babyCount");
		String spouseIncomeAmount = Utility.getDate_TestCase171("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase171("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase171("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase171("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase171("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase171("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase171("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase171("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase171("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase171("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase171("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase171("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase171("childRelationShip");
		String plan = Utility.getDate_TestCase171("plan");
		String brotherRelation = Utility.getDate_TestCase171("brotherRelation");
...
//								ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.stateBenifitPlanThroughJob_S082(secondChildFullName);
		commonMethodPage.clickSaveAndContinueButton();
