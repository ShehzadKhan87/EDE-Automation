...
public class TestCase_177 extends BaseTest {
	...
	public void testCase_177() throws Exception {
		...
		String relationShip = Utility.getDate_TestCase177("relationShip");
		String daughterFirstName = Utility.getDate_TestCase177("daughterFirstName");
		String daughterLastName = Utility.getDate_TestCase177("daughterLastName");
		...
		String daughterIncomeAmount = Utility.getDate_TestCase177("daughterIncomeAmount");
		String daughterIncomeType = Utility.getDate_TestCase177("daughterIncomeType");
		String daughterEmployerName = Utility.getDate_TestCase177("daughterEmployerName");
		String daughterIncomePeriod = Utility.getDate_TestCase177("daughterIncomePeriod");
		...
		String daughterAge = Utility.getDate_TestCase177("daughterAge");
...
//						ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		// help paying for medical bills
		ExtentTestManager.getTest().info("---------------------SCREEN S039----------------------------");
		commonMethodPage.clickSaveAndContinueButton();
