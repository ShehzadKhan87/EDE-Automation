...
public class TestCase_22 extends BaseTest {
	...
	public void testCase_22() throws Exception {
		...
		ExtentTestManager.createTest("Test case 22", "Test case 22");
		...
		// Get data from testcase22.properties
		String state = Utility.getDate_TestCase22("state");
		String firstName = Utility.getDate_TestCase22("firstName");
		String lastName = Utility.getDate_TestCase22("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase22("age");
		String streetAddress = Utility.getDate_TestCase22("streetAddress");
		String city = Utility.getDate_TestCase22("city");
		String zipCode = Utility.getDate_TestCase22("zipCode");
		String county = Utility.getDate_TestCase22("county");
		String phoneNumber = Utility.getDate_TestCase22("phoneNumber");
		String phoneType = Utility.getDate_TestCase22("phoneType");
		String nephewFirstName = Utility.getDate_TestCase22("nephewFirstName");
		String nephewLastName = Utility.getDate_TestCase22("nephewLastName");
		String nephewFullName = nephewFirstName + " " + nephewLastName;
		String nephewAge = Utility.getDate_TestCase22("nephewAge");
		String grandParentFirstName = Utility.getDate_TestCase22("grandParentFirstName");
		String grandParentLastName = Utility.getDate_TestCase22("grandParentLastName");
		String grandParentFullName = grandParentFirstName + " " + grandParentLastName;
		String grandParentAge = Utility.getDate_TestCase22("grandParentAge");
		String unRelatedFirstName = Utility.getDate_TestCase22("unRelatedFirstName");
		String unRelatedLastName = Utility.getDate_TestCase22("unRelatedLastName");
		String unRelatedFullName = unRelatedFirstName + " " + unRelatedLastName;
		String unRelatedAge = Utility.getDate_TestCase22("unRelatedAge");
		String nephew2FirstName = Utility.getDate_TestCase22("nephew2FirstName");
		String nephew2LastName = Utility.getDate_TestCase22("nephew2LastName");
		String nephew2FullName = nephew2FirstName + " " + nephew2LastName;
		String nephew2Age = Utility.getDate_TestCase22("nephew2Age");
		String plan = Utility.getDate_TestCase22("plan");
		String parentRelation = Utility.getDate_TestCase22("parentRelation");
		...
		String s012QuestionUnRelated = "What is " + unRelatedFullName + "'s "
				+ Utility.getFromTextProperties("s012Question");
		...
		String s014QuestionUnRelated = "Is " + unRelatedFullName + " " + Utility.getFromTextProperties("s014Question");
		...
		String s057QuestionUnRelated = "Will " + unRelatedFullName + " "
				+ Utility.getFromTextProperties("s057Question");
		...
		String s058QuestionUnRelated = "Does " + unRelatedFullName + " "
				+ Utility.getFromTextProperties("s058Question") + " " + ESTTimeZone.getCurrentYear() + "?";
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation3G_S27(otherUnRelatedRelation,"not applicable" , "not applicable",
				"not applicable", "1");
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.enterDob(unRelatedAge);
		commonMethodPage.enterFirstName(unRelatedFirstName);
		commonMethodPage.enterLastName(unRelatedLastName);
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation3G_S27(otherUnRelatedRelation, otherUnRelatedRelation, otherUnRelatedRelation,
				"not applicable", "3");
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation3G_S27(nieceRelation, grandChildRelation, otherUnRelatedRelation,
				"not applicable", "3");
		commonMethodPage.clickSaveAndContinueButton();
