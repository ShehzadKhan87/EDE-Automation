...
public class TestCase_113 extends BaseTest {
	@Test
	public void testCase_113() throws Exception {

		ExtentTestManager.createTest("Test case 113", "Test case 113");
		...
		String state = Utility.getDate_TestCase_113("state");
		String firstName = Utility.getDate_TestCase_113("firstName");
		String lastName = Utility.getDate_TestCase_113("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_113("age");
		String streetAddress = Utility.getDate_TestCase_113("streetAddress");
		String city = Utility.getDate_TestCase_113("city");
		String zipCode = Utility.getDate_TestCase_113("zipCode");
		String county = Utility.getDate_TestCase_113("county");
		String phoneNumber = Utility.getDate_TestCase_113("phoneNumber");
		String phoneType = Utility.getDate_TestCase_113("phoneType");
		String SSN = Utility.getDate_TestCase_113("SSN");
		String spouseSSN = Utility.getDate_TestCase_113("spouseSSN");
		String relationShip = Utility.getDate_TestCase_113("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_113("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_113("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase_113("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase_113("babyCount");
		String incomeAmount = Utility.getDate_TestCase_113("incomeAmount");
		String incomeType = Utility.getDate_TestCase_113("incomeType");
		String employerName = Utility.getDate_TestCase_113("employerName");
		String incomePeriod = Utility.getDate_TestCase_113("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase_113("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase_113("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase_113("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase_113("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_113("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_113("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase_113("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase_113("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase_113("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase_113("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase_113("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase_113("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase_113("childRelationShip");
		String plan = Utility.getDate_TestCase_113("plan");
		String brotherRelation = Utility.getDate_TestCase_113("brotherRelation");
		String firstChildSSN = Utility.getDate_TestCase_113("firstChildSSN");
		String secondChildSSN = Utility.getDate_TestCase_113("secondChildSSN");
		String expenseAmount = Utility.getDate_TestCase_113("expenseAmount");
		String coverageName = Utility.getDate_TestCase_113("coverageName");
		String policyNumber = Utility.getDate_TestCase_113("policyNumber");
		...
		String s012QuestionSecondChild = "What is " + secondChildFullName + "' "
				+ Utility.getFromTextProperties("s012Question");
