...
public class TestCase_162 extends BaseTest {
	@Test
	public void testCase_162() throws Exception {

		ExtentTestManager.createTest("Test case 162", "Test case 162");
		...
		// Get data from testcase162.properties
		String state = Utility.getDate_TestCase162("state");
		String firstName = Utility.getDate_TestCase162("firstName");
		String lastName = Utility.getDate_TestCase162("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase162("age");
		String streetAddress = Utility.getDate_TestCase162("streetAddress");
		String city = Utility.getDate_TestCase162("city");
		String zipCode = Utility.getDate_TestCase162("zipCode");
		String county = Utility.getDate_TestCase162("county");
		String phoneNumber = Utility.getDate_TestCase162("phoneNumber");
		String phoneType = Utility.getDate_TestCase162("phoneType");
		String SSN = Utility.getDate_TestCase162("SSN");
		String spouseSSN = Utility.getDate_TestCase162("spouseSSN");
		String relationShip = Utility.getDate_TestCase162("relationShip");
		String spouseFirstName = Utility.getDate_TestCase162("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase162("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase162("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase162("babyCount");
		String incomeAmount = Utility.getDate_TestCase162("incomeAmount");
		String incomeType = Utility.getDate_TestCase162("incomeType");
		String employerName = Utility.getDate_TestCase162("employerName");
		String incomePeriod = Utility.getDate_TestCase162("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase162("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase162("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase162("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase162("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase162("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase162("gotMarried");
		String childFirstName = Utility.getDate_TestCase162("childFirstName");
		String childLastName = Utility.getDate_TestCase162("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase162("childAge");
		String childRelationShip = Utility.getDate_TestCase162("childRelationShip");
		String plan = Utility.getDate_TestCase162("plan");
		String withoutDocument = Utility.getDate_TestCase162("withoutDocument");
		String expenseAmount = Utility.getDate_TestCase162("expenseAmount");
		String anualPredictedAmount = Utility.getDate_TestCase162("anualPredictedAmount");
		String spouseAge = Utility.getDate_TestCase162("spouseAge");
		...
		String indivitualStartDate = ESTTimeZone.getAdvanceDate("30", "MM/dd/yyyy");
		String indivitualNoticeDate = ESTTimeZone.getPreviousDate("60", "MM/dd/yyyy");
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation3G_S27(childRelationShip, childRelationShip, "Not Applicable", "Not applicable",
				"2");
		commonMethodPage.clickSaveAndContinueButton();
