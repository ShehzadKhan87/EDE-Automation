...
public class TestCase_175 extends BaseTest {
	@Test
	public void testCase_175() throws Exception {

		ExtentTestManager.createTest("Test case 175", "Test case 175");
		...
		String state = Utility.getDate_TestCase_175("state");
		String firstName = Utility.getDate_TestCase_175("firstName");
		String lastName = Utility.getDate_TestCase_175("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_175("age");
		String streetAddress = Utility.getDate_TestCase_175("streetAddress");
		String city = Utility.getDate_TestCase_175("city");
		String zipCode = Utility.getDate_TestCase_175("zipCode");
		String county = Utility.getDate_TestCase_175("county");
		String phoneNumber = Utility.getDate_TestCase_175("phoneNumber");
		String phoneType = Utility.getDate_TestCase_175("phoneType");
		String s050OptionPregnant = Utility.getDate_TestCase_175("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase_175("babyCount");
		String incomeAmount = Utility.getDate_TestCase_175("incomeAmount");
		String incomeType = Utility.getDate_TestCase_175("incomeType");
		String employerName = Utility.getDate_TestCase_175("employerName");
		String incomePeriod = Utility.getDate_TestCase_175("incomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_175("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_175("gotMarried");
		String childFirstName = Utility.getDate_TestCase_175("childFirstName");
		String childLastName = Utility.getDate_TestCase_175("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_175("childAge");
		String childRelationShip = Utility.getDate_TestCase_175("childRelationShip");
		String plan = Utility.getDate_TestCase_175("plan");
		...
		String s082Question = Utility.getFromTextProperties("s082Question2");
...
//				ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.stateBenifitPlanThroughJob_S082(applicantFullName);
		commonMethodPage.clickSaveAndContinueButton();
