...
public class TestCase_43 extends BaseTest {
	@Test
	public void testCase2_D() throws Exception {
		...
		String state = Utility.getDate_TestCase_43("state");
		String firstName = Utility.getDate_TestCase_43("firstName");
		String lastName = Utility.getDate_TestCase_43("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_43("age");
		String streetAddress = Utility.getDate_TestCase_43("streetAddress");
		String city = Utility.getDate_TestCase_43("city");
		String zipCode = Utility.getDate_TestCase_43("zipCode");
		String county = Utility.getDate_TestCase_43("county");
		String phoneNumber = Utility.getDate_TestCase_43("phoneNumber");
		String phoneType = Utility.getDate_TestCase_43("phoneType");
		String relationShip = Utility.getDate_TestCase_43("relationShip");
		String daughterFirstName = Utility.getDate_TestCase_43("daughterFirstName");
		String daughterLastName = Utility.getDate_TestCase_43("daughterLastName");
		String daughterFullName = daughterFirstName + " " + daughterLastName;
		String incomeAmount = Utility.getDate_TestCase_43("incomeAmount");
		String incomeType = Utility.getDate_TestCase_43("incomeType");
		String employerName = Utility.getDate_TestCase_43("employerName");
		String incomePeriod = Utility.getDate_TestCase_43("incomePeriod");
		String daughterIncomeAmount = Utility.getDate_TestCase_43("daughterIncomeAmount");
		String daughterIncomeType = Utility.getDate_TestCase_43("daughterIncomeType");
		String daughterEmployerName = Utility.getDate_TestCase_43("daughterEmployerName");
		String daughterIncomePeriod = Utility.getDate_TestCase_43("daughterIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_43("EmployerPhone");
		String fullTimeStudent = Utility.getDate_TestCase_43("fullTimeStudent");
		String grandChildFirstName = Utility.getDate_TestCase_43("grandChildFirstName");
		String grandChildLastName = Utility.getDate_TestCase_43("grandChildLastName");
		String grandChildFullName = grandChildFirstName + " " + grandChildLastName;
		String grandChiledAge = Utility.getDate_TestCase_43("grandChildAge");
		String loseCoverageDate = ESTTimeZone.getPreviousDate("48", "MM/dd/yyyy");
		String daughterAge = Utility.getDate_TestCase_43("daughterAge");
		...
		commonMethodPage.enterDob(grandChiledAge);
		commonMethodPage.enterFirstName(grandChildFirstName);
		commonMethodPage.enterLastName(grandChildLastName);
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation(grandChildRelation, relationShip, "not applicable", "2");
		...
		commonMethodPage.applicantTakeCareOfChildrenFirst_S038(grandChildFirstName);
		commonMethodPage.clickSaveAndContinueButton();
		Wait.wait5Second();
		Wait.wait2Second();
