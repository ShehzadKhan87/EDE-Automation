...
public class TestCase_120 extends BaseTest {
	@Test
	public void testCase_120() throws Exception {

		ExtentTestManager.createTest("Test case 120", "Test case 120");
		...
		String state = Utility.getDate_TestCase_120("state");
		String firstName = Utility.getDate_TestCase_120("firstName");
		String lastName = Utility.getDate_TestCase_120("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_120("age");
		String streetAddress = Utility.getDate_TestCase_120("streetAddress");
		String city = Utility.getDate_TestCase_120("city");
		String zipCode = Utility.getDate_TestCase_120("zipCode");
		String county = Utility.getDate_TestCase_120("county");
		String phoneNumber = Utility.getDate_TestCase_120("phoneNumber");
		String phoneType = Utility.getDate_TestCase_120("phoneType");
		String SSN = Utility.getDate_TestCase_120("SSN");
		String spouseSSN = Utility.getDate_TestCase_120("spouseSSN");
		String relationShip = Utility.getDate_TestCase_120("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_120("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_120("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase_120("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase_120("babyCount");
		String incomeAmount = Utility.getDate_TestCase_120("incomeAmount");
		String incomeType = Utility.getDate_TestCase_120("incomeType");
		String employerName = Utility.getDate_TestCase_120("employerName");
		String incomePeriod = Utility.getDate_TestCase_120("incomePeriod");
		String spouseIncomeAmount = Utility.getDate_TestCase_120("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase_120("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase_120("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase_120("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase_120("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_120("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase_120("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase_120("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase_120("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase_120("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase_120("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase_120("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase_120("childRelationShip");
		String plan = Utility.getDate_TestCase_120("plan");
		String brotherRelation = Utility.getDate_TestCase_120("brotherRelation");
		String firstChildSSN = Utility.getDate_TestCase_120("firstChildSSN");
		String secondChildSSN = Utility.getDate_TestCase_120("secondChildSSN");
		String expenseAmount = Utility.getDate_TestCase_120("expenseAmount");
		String coverageName = Utility.getDate_TestCase_120("coverageName");
		String policyNumber = Utility.getDate_TestCase_120("policyNumber");
		String coverageEndReason = Utility.getDate_TestCase_120("coverageEndReason");
...
//														ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.coverageThroughJobEndedInLast3Months_S081(secondChildFullName);
		commonMethodPage.whyCoverageEnd_S081(coverageEndReason);
		commonMethodPage.whyCoverageEnd_S081_2(coverageEndReason);
		commonMethodPage.clickSaveAndContinueButton();
